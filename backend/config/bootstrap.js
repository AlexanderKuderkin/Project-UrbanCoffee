...
module.exports.bootstrap = async function() {
  ...
  await Coffee.createEach([
    ...
    },
    {
        ...
        price: 4.99,
        description: "A smooth and balanced medium roast for a perfect start to your day.",
        caffeineContent: 180.00,
        brand: "Tchibo",
        roastDegree: "Medium roast",
        beanType: "Arabica",
        certificates: ["Fair Trade Certified", "Rainforest Alliance Certified"],
        origin: "South-America",
        grindType: "Medium",
        category: categories[1].id,
        imagePath: "src/assets/CoffeeAll.jpg"
      },
      {
        name: "Robusta Energy",
        price: 3.49,
        description: "A bold, dark roast with an extra caffeine kick for energy lovers.",
        caffeineContent: 230.00,
        brand: "Jacobs",
        roastDegree: "Dark roast",
        beanType: "Robusta",
        certificates: ["UTZ Certified"],
      ...
      },
      {
        ...
        price: 4.50,
        description: "A traditional European light roast with a mild flavor.",
        caffeineContent: 150.00,
        brand: "Eduscho",
        roastDegree: "Light roast",
        beanType: "Arabica",
      ...
      },
      {
        name: "Espresso Kick",
        price: 4.99,
        description: "An intense, dark roast espresso blend for true coffee enthusiasts.",
        caffeineContent: 210.00,
        brand: "Mellitta",
        roastDegree: "Dark roast",
        beanType: "Robusta",
      ...
      },
      {
        ...
        price: 3.99,
        description: "A rich medium-dark roast with fruity undertones.",
        caffeineContent: 190.00,
        brand: "Tchibo",
        roastDegree: "Medium-dark roast",
        beanType: "Arabica",
      ...
      },
      {
        name: "Smooth Velvet",
        price: 4.20,
        description: "A velvety medium roast with a nutty finish.",
        caffeineContent: 160.00,
        brand: "Jacobs",
        roastDegree: "Medium roast",
        beanType: "Arabica",
      ...
      },
      {
        name: "Bold Awakening",
        price: 3.70,
        description: "A robust dark roast for a strong and satisfying coffee experience.",
        caffeineContent: 200.00,
        brand: "Eduscho",
        roastDegree: "Dark roast",
        beanType: "Robusta",
      ...
      },
      {
        name: "Golden Blend",
        price: 4.89,
        description: "A carefully crafted blend of Arabica and Robusta for a balanced flavor.",
        caffeineContent: 185.00,
        brand: "Mellitta",
        roastDegree: "Medium-dark roast",
        beanType: "Arabica",
      ...
      },
      {
        ...
        price: 4.50,
        description: "A light roast with a bright, citrusy aroma.",
        caffeineContent: 140.00,
        brand: "Tchibo",
        roastDegree: "Light roast",
        beanType: "Arabica",
      ...
      },
      {
        name: "Midnight Roast",
        price: 4.99,
        description: "A deep, smoky dark roast for late-night coffee lovers.",
        caffeineContent: 220.00,
        brand: "Jacobs",
        roastDegree: "Dark roast",
        beanType: "Robusta",
        certificates: ["Fair Trade Certified"],
